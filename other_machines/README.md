...
- `train_and_eval_retro_atom_product_memory.sh`：改进后的 global R-SMILES Atom-level Product-Memory 训练与 dev_unique1000 Euler N=9 评估；Atom 长序列使用 `batch_size=128`，用于和 Atom baseline 做单变量对照；
