...
### 6.1 旧 checkpoint 同配置配对

为隔离“训练变化”和“参数变化”，旧 `checkpoint_step600000.pt` 在完全相同的 mini、
seed、R9K1M2 和评分协议下完成了配对：

| checkpoint | Top-1 | Top-2 | Top-3 | Top-5 | Top-10 | Oracle | rank-1 invalid | mean final rank | wall |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 旧 checkpoint | 57.043 | 71.528 | 78.122 | 82.617 | 86.114 | 91.808 | 13.666% | 3.047 | 2046.70 s |
| 新 checkpoint | 58.242 | 72.028 | 77.922 | 83.017 | 86.414 | 91.508 | 12.767% | 2.783 | 2029.18 s |
| 新−旧（百分点） | +1.199 | +0.500 | −0.200 | +0.400 | +0.300 | −0.300 | −0.899 | — | −17.52 s |

新旧 mini 的 Top-1～10 差异都在约 1.2 个百分点以内，Oracle 几乎相同；新模型的覆盖
目标平均排名更靠前、invalid 略低，但 true-unique 候选从旧模型的 25.812 降到 23.737。
这说明 Noam/复现修复后的新训练没有在该 1001 反应子集上造成明显退化，也不能宣称已经
显著提升；validation-200 中 R/K/M 参数带来的 4～8 个百分点变化更大。
